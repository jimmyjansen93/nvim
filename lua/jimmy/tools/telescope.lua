return {
  {
    ...
    config = function()
      ...
      require("which-key").add({
        { "grs", builtin.lsp_document_symbols, desc = "Document Symbols", icon = docIcon },
        { "grw", builtin.lsp_dynamic_workspace_symbols, desc = "Workspace Symbols", icon = workIcon },

        { "gdd", require("telescope.builtin").lsp_definitions, desc = "Goto Definition" },
        ...
        { "gdt", require("telescope.builtin").lsp_type_definitions, desc = "Type Definition" },
      })
