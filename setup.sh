...
start_subtask "Install language servers and tools"
...
end_subtask "Install language servers and tools" true

start_subtask "Install neovim"
brew install neovim >/dev/null 2>&1
end_subtask "Install neovim" true
